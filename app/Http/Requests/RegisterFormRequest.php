...
class RegisterFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'tprovince' => 'required|string|max:50|regex:/(^[-0-9A-Za-z.,\/ ]+$)/',
            ...
            'eprovince' => 'required|string|max:50|regex:/(^[-0-9A-Za-z.,\/ ]+$)/',
    ...
    public function messages()
    {
        return [
            ...
            'tprovince.regex' => 'The province/state format is invalid.',
            'tprovince.max' => 'The province/state may not be greater than 50 characters.',
//            'tcountry.required'=> 'The country field is required.',
            ...
            'eprovince.regex' => 'The province/state format is invalid.',
            'eprovince.max' => 'The province/state may not be greater than 50 characters.',
