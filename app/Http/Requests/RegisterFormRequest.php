...
class RegisterFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'tprovince' => 'nullable|string|max:50|regex:/(^[-0-9A-Za-z.,\/ ]+$)/',
            ...
            'eprovince' => 'nullable|string|max:50|regex:/(^[-0-9A-Za-z.,\/ ]+$)/',
            ...
            'mobile_number' => 'required|numeric|digits_between:10,12|regex:/^[0-9]{2}[0-9]{9}$/',
            'terms' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'province.required' => 'The state/province is required.',
            'province.regex' => 'The state/province format is invalid.',
            'province.max' => 'The state/province may not be greater than 50 characters.',
            ...
            'tprovince.regex' => 'The state/province format is invalid.',
            'tprovince.max' => 'The state/province may not be greater than 50 characters.',
//            'tcountry.required'=> 'The country field is required.',
            ...
            'eprovince.regex' => 'The state/province format is invalid.',
            'eprovince.max' => 'The state/province may not be greater than 50 characters.',
