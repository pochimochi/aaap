                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group input-group-alternative">
                                                        ...
                                                        <input class="form-control datepicker datepicker-orient-right" name="due_date" id="due_date" placeholder="Select date" type="date" value="{{ \Carbon\Carbon::parse($announcement->due_date)->format('Y-m-d')}}">
                                                    </div>
                                                </div>
